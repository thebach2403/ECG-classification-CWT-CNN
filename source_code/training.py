...
DATA_ROOT_PATH = Path("E:/pv/WORKING/ECG_main_folder/ECG_Classification_CWT_CNN/data")
OUTPUT_MODEL_PATH = Path("E:/pv/WORKING/ECG_main_folder/ECG_Classification_CWT_CNN/model_save/ecg_model.pth")
batch_size = 32
num_epochs = 10
